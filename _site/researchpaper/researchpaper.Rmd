...
The relevant R package used is **tidytext**, where the "bind_tf_idf" function helps to compute and bind the term frequency, inverse document frequency and td-idf of a tdy text dataset to the dataset. 
